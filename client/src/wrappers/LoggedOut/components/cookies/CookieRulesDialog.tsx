    ...
    <Dialog open={open} scroll="paper" onClose={onClose} className={classes.dialog}>
      ...
      <DialogContent>
        ...
        <Typography paragraph>
          ...
          functionality. For more general information on cookies see the Wikipedia article on HTTP
          Cookies.
        </Typography>
        <Typography variant="h6" color="primary" paragraph>
          How We Use Cookies
        ...
        <Typography paragraph>
          ...
          something that you aren&apos;t sure whether you need or not it&apos;s usually safer to
          leave cookies enabled in case it does interact with one of the features you use on our
          site. This Cookies Policy was created with the help of the Cookies Policy Template
          Generator and the Terms and Conditions Template.
        </Typography>
        <Typography paragraph>
          However if you are still looking for more information then you can contact us by sending
          an email to tim.v.kaenel@gmail.com.
        </Typography>
      </DialogContent>
      <DialogActions className={classes.dialogActions}>
        <ColoredButton onClick={onClose} variant="contained" color={theme.palette.common.black}>
