...
function RegisterDialog(props) {
  ...
  const registerTermsCheckbox = useRef<{ checked: boolean }>()
  const registerPassword = useRef<{ value: string }>()
  const registerPasswordRepeat = useRef<{ value: string }>()
        ...
        <Fragment>
          ...
          {status === 'accountCreated' ? (
            <HighlightedInformation>
              We have created your account. Please click on the link in the email we have sent to
              you before logging in.
            </HighlightedInformation>
          ) : (
            <HighlightedInformation>
